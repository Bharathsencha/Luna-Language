...
Value lib_math_abs(int argc, Value *argv, Env *env) {
...
Value lib_math_min(int argc, Value *argv, Env *env) {
...
Value lib_math_max(int argc, Value *argv, Env *env) {
...
Value lib_math_clamp(int argc, Value *argv, Env *env) {
...
Value lib_math_sign(int argc, Value *argv, Env *env) {
...
Value lib_math_mod(int argc, Value *argv, Env *env) {
...
Value lib_math_trand(int argc, Value *argv, Env *env) {
    (void)argc; (void)argv; (void)env;
    return value_int((long long)get_os_entropy());
}

Value lib_math_srand(int argc, Value *argv, Env *env) {
    uint64_t seed;
    if (argc == 0) {
        seed = get_os_entropy();
    } else {
...
Value lib_math_rand(int argc, Value *argv, Env *env) {
    if (argc == 0) {
        uint64_t r = next();
